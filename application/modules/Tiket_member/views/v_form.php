<div class="col-md-8">  
  ...
  <div class="col-md-6">
    <div class="modal fade" id="modal-proses" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
        <div class="modal-dialog modal- modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Request Pembelian ticket <span id="name_mem"></span></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body" style="overflow:auto;">
                <form action="#" method="post" id="formAksi2">
                        <h6 class="heading-small text-muted mb-4">Member Information</h6> 
                        <input type="hidden" id="mem_kode2" name ="mem_kode2" class="form-control">
                        <div class="pl-lg-4">
                          <div class="row"> 
                            <div class="col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="mem_name">Nama Lengkap</label>
                                <input type="text" id="mem_name2" name ="mem_name2" class="form-control" placeholder="Nama Lengkap" readonly>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="mem_addr2">Alamat</label>
                                <input type="text" id="mem_addr2" name ="mem_addr2" class="form-control" placeholder="Alamat" readonly>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="mem_mail2">Email</label>
                                <input type="text" id="mem_mail2" name ="mem_mail2" class="form-control" placeholder="Email" readonly>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="mem_phone2">No.Whatsapp</label>
                                <input type="text" id="mem_phone2" name ="mem_phone2" class="form-control" placeholder="Phone" readonly>
                              </div>
                            </div>
                            <div class="col-lg-12">
                              <div class="form-group">
                                <label class="form-control-label" for="mem_request">Request</label>
                                <input type="text" id="mem_request2" name ="mem_request2" class="form-control" placeholder="Request" >
                              </div>
                            </div>
            ...
            $.ajax({
                    ...
                    success: function(data){ 
                      if (data.includes("Berhasil") == true) {
                        ...
                        alert("Berhasil Request Ticket");
                        datatable("Active"); 
                      }else{
                        alert("Gagal Request,Periksa inputan anda");
                      }  
                    }           
                });
                return false;
