...
class Repassword extends CI_Controller{
	function __construct(){
		parent::__construct();
		$this->load->model('M_repassword');
        $this->load->helper('captcha');
	}
	
	private $primary_key = "fc_mail";
	private $secondary_key = "fc_username";
...
//            'img_height' => 30,
	...
	public function Simpan($data){ 
		...
		$data_mail = array(
			...
			$where = array($this->$this->secondary_key => $this->input->post('mem_username'));
			$proses = $this->M_repassword->update($data,$where);
