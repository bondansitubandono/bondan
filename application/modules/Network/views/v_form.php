          ...
          <div class="modal-content">
            ...
            <div class="card">
                ...
                <div class="card-body px-lg-5 py-lg-5"> 
                    <form action="<?php echo  site_url().'Network/Simpan'; ?>" method="post" id="formAksi">
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <input type="text" id="ref_code" name="ref_code" readonly="true" class="form-control" value="<?php echo $this->session->userdata('fc_referral_id'); ?>" placeholder="masukkan kode sponsor">
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label class="form-control-label" for="mem_name">Nama Lengkap</label>
                              <input type="text" id="mem_name" name ="mem_name"  onkeyup="NameMember()"  class="form-control" placeholder="Nama Lengkap" required>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" id="mem_nama_rekening" name ="mem_nama_rekening" class="form-control" placeholder="Nama Rekening" required readonly="true">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                  ...
                  <label class="custom-control-label" for=" customCheckLogin">
                    <span class="text-muted" style="color:green; font-size:10px;">Saya setuju dengan Syarat dan Ketentuan yang Berlaku</span>
                        ...
                        <button type="button" class="btn btn-danger my-4" data-dismiss="modal">Batal</button>
                            <button type="submit" id="myBtn" class="btn btn-primary my-4">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
