<body class="bg-default"> 
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <div id="f1">
                              <input type="text" id="ref_code2" name="ref_code2" class="form-control" placeholder="masukkan kode sponsor" value="<?php echo $this->uri->segment(3); ?>" >
                             
                              </div><?php } else { ?>
                              <div id="f2" > 
                              <input type="text" id="ref_code" name="ref_code" class="form-control" placeholder="masukkan kode sponsor" value="1" >
                              </div><?php } ?>
                              </div>
                          </div>
                          <div class="col-lg-6">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" id="mem_password" name ="mem_password" class="form-control" placeholder="Password" minlenght="6" required>
                            <div id="noti"></div>
                            </div>
                          </div>
                          <div class="col-lg-6">
  ...
  <script type="text/javascript">
   ...
   // var kunci = "<?php echo $this->uri->segment(3);?>"; 
    $(document).ready(function(){
      
    var kunci = "<?php echo $this->uri->segment(2);?>";
    if(kunci == "edit"  ){
       }
    else{
      Cekkode();
    ...
    function getPass(){
     ...
     if( document.getElementById("mem_username").value==document.getElementById("mem_password").value){
     document.getElementById("noti").innerHTML = "  <span style='color: red; font-size:10px;'>* password tidak boleh sama dengan username </span>";
     }
     else {
      document.getElementById("noti").innerHTML = "  <span style='color: green; font-size:10px;'>* password bisa di gunakan </span>";
